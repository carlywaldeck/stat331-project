...
animation <- ggplot(data_joined_2, aes(x = log(gdp_pcap), y = log(food_supply), color = country)) +
  ...
  labs(
    title = "GDP vs Food Consumption Over Time",
    subtitle = "Year: {frame_time}",
    x = "GDP per Capita (USD)",
    y = "Food Consumption (kcal/person/day)"
  ) +
  theme_minimal() +
...
<<<<<<< HEAD
The expected natural logarithm of average food consumption is 6.8950 when the natural logarithm of average GDP per capita is zero.
=======
...
>>>>>>> 16ab8d11d452dd75b8834fdb302b30528075fba4
