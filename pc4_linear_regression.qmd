...
It can be seen from the scatterplot above that, after applying a logarithmic transformation, there is a moderately strong, positive, linear relationship between log(Average GDP) and log(Average Food Consumption) for the subsetted data from 2012-2018.
...
It can be seen that the relationship between log(Average GDP) and log(Average Food Consumption) initially is weak, positive, and linear, but evolves to a stronger, positive, linear relationship over time.
