...
Since we did not include every country in the GDP per capita data, are analysis may be limited. Furthermore, we only include years for which we had data from both the GDP per capita and food consumption data set. 
