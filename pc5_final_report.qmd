...
The above table shows the model fit for the linear regression model in the previous. Foremost, the models R\^2 is 0.62, which means 62% of variation if food consumption in kilocalories is explained by GDP per capita.
